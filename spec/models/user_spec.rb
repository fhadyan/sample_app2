...
describe User do
  ...
  describe "password encryption" do
    ...
    describe "has_password? method" do
      ...
      it "should be true if password mathc" do
    ...
    describe "authenticate method" do 
      ...
      it "should return nil for an email with no user" do
        wrong_user = User.authenticate("foo@bar.com", @attr[:password])
  ...
  describe "admin attribut" do
    ...
    it "should cenvertiable to admin" do
      @user.toggle!(:admin)
  ...
  describe "micropost association" do
    ...
    it "should have a micropost attributes" do
      @user.should respond_to(:microposts)
    end

    it "should have the right micropost in right order" do
    ...
    describe "status feed" do
      ...
      it "should have status feed" do
        @user.should respond_to(:feed)
      end

      it "should include user own's feed" do
